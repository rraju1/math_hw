...
\begin{enumerate}
	...
	\item 
	\item 
	\item Choose two points $a_1, a_2 \in B(x,r)$ s.t. $a_1 = [x_1 + r, x_2, x_3, \dots], a_2 = [x_1 - r, x_2, x_3, \dots].$ $\diam{B(x,r)}= \sup\{d(a_1, a_2): a_1, a_2 \in B(x,r)\}.$ Apply triangle inequality to $d(a_1, a_2) \rightarrow d(a_1, a_2) \leq d(a_1, x) + d(x, a_2).$ So, $\diam{B(x,r)} = \sup \{d(a_1, a_2) \leq \norm{r} + \norm{r}\} = \sup (d(a_1, a_2) \leq 2r) = 2r.$
\end{enumerate}
\end{solution}
