...
\begin{enumerate}
	\itemsep0em
	\item Let us solve by proof of contridiction. Suppose $r + x$ and $rx$ is rational. Since $r$ is rational, $-r$ and \(\frac{1}{r}\) are also rational. Thus, $(r + x) - r = x$ which implies x is rational by property of addition of rationals. 
